...
class HRMCausalBlock(HierarchicalReasoningModel_ACTV1Block):
    ...
    def __init__(
        self, config: HierarchicalReasoningModel_ACTV1Config, causal: bool = True
    ) -> None:
        """
...
def create_causal_hrm_blocks(
    config: HierarchicalReasoningModel_ACTV1Config, causal: bool = True
    ...
    H_level = HRMCausalReasoningModule.from_config(
        config=config, num_layers=config.H_layers, causal=causal
    )

    L_level = HRMCausalReasoningModule.from_config(
        config=config, num_layers=config.L_layers, causal=causal
    )
